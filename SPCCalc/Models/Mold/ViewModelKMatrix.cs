...
{
    [Table("spc_MoldKMatrixTOKTKN")]
    public class ViewModelKMatrix
    {
        [Key]
    ...
    [Table("VN_MachineList_MoldKMatrixTOKTKN")]
    public class ViewModelKMatrixMachines
    {
        [Key]
    ...
    [Table("spViewDataForCamstarMoldKMatrix")]
    public class ViewModelKMatrixWipDataValues
    {
        [Key]
        public string RowNo { get; set; }
        public string LotNumber { get; set; }
